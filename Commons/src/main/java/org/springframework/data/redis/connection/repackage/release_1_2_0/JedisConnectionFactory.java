 ...
 *
 * DO MAKE SURE THAT IT GENERATES THE JedisConnection OBJECT  WHICH IS REPACKAGED AND implements the EnhancedRedisConnection Interface.!!!
 * @author Costin Leau
 * @author zhangwei
 */
public class JedisConnectionFactory implements InitializingBean, DisposableBean, org.springframework.data.redis.connection.RedisConnectionFactory {
    ...
    /**
     * Post processMessageBody a newly retrieved connection. Useful for decorating or executing initialization commands on a new
