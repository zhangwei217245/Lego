...
/**
 * Created by zhangwei on 14-4-17.
 */
 ...
 * @author zhangwei
 */
public class JedisConnection implements EnhancedRedisConnection {
    ...
    public Object execute(String command, byte[]... args) {
        ...
        try {
            ...
            ReflectionUtils.invokeMethod(SEND_COMMAND, client, Protocol.Command.valueOf(command.trim().toUpperCase()),
